    ...
    e._temp_matrix_scope = function() {
        ...
        function d(a) {
            ...
            for (var v = 0; v < this.y_unit.length; v++) {
                ...
                if (n += "<tr class='" + y.tr_className + "' style='" + y.style_height + "'><td class='" + y.td_className + "' style='" + y.style_width + " height:" + (y.height - 1) + "px;'>" + y.td_content + "</td>", "cell" == this.render)
                    for (var o = 0; o < e._cols.length; o++) n += e._ignores[o] ? "<td></td>" : "<td class='dhx_matrix_cell " + e.templates[this.name + "_cell_class"](i[v][o], this._trace_x[o], this.y_unit[v], v, o) + "' style='width:" + (e._cols[o] - 1) + "px'><div style='width:" + (e._cols[o] - 1) + "px'>" + e.templates[this.name + "_cell_value"](i[v][o], this._trace_x[o], this.y_unit[v]) + "</div></td>";
                else {
                    ...
                    for (var o = 0; o < e._cols.length; o++) n += e._ignores[o] ? "<td></td>" : "<td data-cell-cordinate='"+v+'-'+o+" 'id='"+this.y_unit[v].key+this._trace_x[o].getFullYear()+this._trace_x[o].getMonth()+this._trace_x[o].getDate()+this._trace_x[o].getHours()+this._trace_x[o].getMinutes()+"' class='dhx_matrix_cell " + e.templates[this.name + "_cell_class"](i[v], this._trace_x[o], this.y_unit[v], v, o) + "' style='width:" + (e._cols[o] - 1) + "px'><div style='width:" + (e._cols[o] - 1) + "px'></div></td>";
                    n += "</table>", n += "</div></td>";
                }
                n += "</tr>", b.push(y)
            }
        ...
        function o(t) {
            ...
            for (var o = e._min_date_timeline = e._min_date,
                     ...
                     c = l.call(this, _), u = c.displayed,
                     h = c.total,
                     p = 0; h > p; p++)

                e._ignores[p] ? (e._cols[p] = 0, u++) : e._cols[p] = Math.floor(i / (u - p)), i -= e._cols[p], r[p + 1] = r[p] + e._cols[p];
        ...
        e.matrix = {}, e._merge = function(e, t) {
            ...
            var h = t.color ? "background:" + t.color + ";" : "",
                ...
                m = '<div event_id="' + t.id + '" class="' + u + '" style="' + h + p + "position:absolute; top:" + _ + "px; height: " + s + "px; left:" + d + "px; width:" + Math.max(0, l - d +10) + "px;" + (t._text_style || "") + '">';
