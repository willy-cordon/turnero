                    ...
                    <form method="POST" action="{{ route('password.request') }}">
                        ...
                        <h1>
                            <div class="login-logo">
                                <a href="{{env('APP_URL')}}">
                                    <img class="app-logo" src="{{asset('img/logo-new.png')}}" title="{{ env('APP_NAME') }}"/>
                                </a>
                            </div>
                        </h1>
                        ...
                        <div>
                            ...
                            <div class="form-group has-feedback">
                                <input type="password" name="password_confirmation" class="form-control" required placeholder="{{ trans('global.confirm_password') }}">
